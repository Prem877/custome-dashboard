import { ChevronLeft, ChevronRight, Layers } from "react-feather";
import { LineChart1, SparklineChart2, SparklineChart3, SparklineChart4 } from "../charts/LineCharts";
...
import RealtimeStatics from "../charts/RealtimeStatics";
import GaugeChart from "../charts/GaugeChart";
import VectorMapComponent from "../map/VectorMapComponent";
                ...
                <div className="row page-title-header">
                    <div className="col-12">
                        <div className="page-header">
                            ...
                            <div className="w-100 d-md-flex flex-md-wrap">
                                <ul className="quick-links">
                                    <li><a href="#">ICE Market data</a></li>
                                    <li><a href="#">Own analysis</a></li>
                                    <li><a href="#">Historic market data</a></li>
                                </ul>
                                <ul className="quick-links ms-auto">
                    ...
                    <div className="col-md-12">
                        <div className="page-header-toolbar">
                            <div className="btn-group toolbar-item" role="group" aria-label="Basic example">
                                <button type="button" className="btn btn-secondary"><ChevronLeft /></button>
                                <button type="button" className="btn btn-secondary">03/02/2019 - 20/08/2019</button>
                                <button type="button" className="btn btn-secondary"><ChevronRight /></button>
                            </div>
                            <div className="filter-wrapper">
                                <div className="dropdown toolbar-item">
                                    <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownsorting" data-bs-toggle="dropdown" aria-expanded="false">All Day</button>
                            ...
                            <div className="sort-wrapper">
                                ...
                                <div className="dropdown ms-lg-auto ms-3 toolbar-item">
                                    <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownexport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Export</button>
                                ...
                                <div className="d-flex flex-column flex-lg-row">
                                    ...
                                    <ul className="nav nav-tabs sales-mini-tabs ms-lg-auto mb-4 mb-md-0" role="tablist">
                                        <li className="nav-item">
                                            <a className="nav-link active" id="sales-statistics_switch_1" data-bs-toggle="tab" role="tab" aria-selected="true">1D</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" id="sales-statistics_switch_2" data-bs-toggle="tab" role="tab" aria-selected="false">5D</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" id="sales-statistics_switch_3" data-bs-toggle="tab" role="tab" aria-selected="false">1M</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" id="sales-statistics_switch_4" data-bs-toggle="tab" role="tab" aria-selected="false">1Y</a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="d-flex flex-column flex-lg-row">
                                    <div className="data-wrapper d-flex mt-2 mt-lg-0">
                                        <div className="wrapper pr-5">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <small className="ms-2 text-gray d-none d-lg-block"><b>89.5%</b> of 20,000 Total</small>
                                            </div>
                                        </div>
                                        <div className="wrapper">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <small className="ms-2 text-gray d-none d-lg-block"><b>10.5%</b> of 20,000 Total</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="ms-lg-auto" id="sales-statistics-legend"></div>
                                </div>
                                <span className="mt-5">
                                    <SalesChart />
                                </span>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between w-100">
                                            ...
                                            <div className="dropdown">
                                                <button className="btn btn-outline-secondary dropdown-toggle" type="button" id="dateSorter" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">This Month</button>
                                        ...
                                        <div className="d-flex align-items-end">
                                            ...
                                            <p className="mb-0 font-weight-medium ms-2 ms-2 mb-1">USD</p>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="d-flex align-items-center pb-2">
                                                    <div className="dot-indicator bg-danger ms-2"></div>
                                            ...
                                            <div className="col-md-6 mt-4 mt-md-0">
                                                <div className="d-flex align-items-center pb-2">
                                                    <div className="dot-indicator bg-success ms-2"></div>
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                <div className="d-flex align-items-center mb-2">
                                                    <div className="icon-holder bg-primary text-white py-1 px-3 rounded ms-2">
                                                        <Layers size={20} />
                                                    </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex mt-3 py-2 border-bottom">
                                            <Image className="img-sm rounded-circle" src={face3} alt="profile image" />
                                        ...
                                        <div className="d-flex py-2 border-bottom">
                                            <Image className="img-sm rounded-circle" src={face4} alt="profile image" />
                                            <div className="wrapper ms-2">
